...
INSERT INTO users(email,password) VALUES ('lazy-panda@project.com','@!PANDA!@');

-- Insert sample data into posts
INSERT INTO posts(title, content, user_id) VALUES ('First Panda Post', 'This is the content of the first Panda post.', 1);

-- Insert sample data into comments
INSERT INTO comments(comment, user_id, post_id) VALUES ('This is a comment on the first Panda post.', 1, 1);
